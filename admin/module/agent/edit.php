...
<?php
    ...
    $id = $_GET['id'];
    $row = Connect::conn()->get("agent","*",['id' => $_GET['id']]);
?>
...
<form action="" method="post"  enctype="multipart/form-data">
  <div class="box">
    <div class="box-header with-border">
      <h3 class="box-title">แก้ไขตัวแทน</h3>
    </div>
    <div class="box-body">
     <?php 
        if(isset($_POST['button'])  && $_POST['button'] == "confirm") {
            $target_dir = "uploads/";
                        ...
                        <div class="is-center">
                            <h4>แก้ไขตัวแทน<?php echo $resultTxt; ?> </h4>
    ...
    ?>
     <div ng-init="controller.field.name = '<?php echo $row['name'] ?>';
                    controller.field.code = '<?php echo $row['code'] ?>';
                    controller.field.fb = '<?php echo $row['fb'] ?>';
                    controller.field.tel = '<?php echo $row['tel'] ?>';
                    controller.field.line = '<?php echo $row['line'] ?>';
                    controller.field.lvl_id = '<?php echo $row['lvl_id'] ?>';
                    controller.field.district = '<?php echo $row['district'] ?>';
                    controller.field.province = '<?php echo $row['province'] ?>';
