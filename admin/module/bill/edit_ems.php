            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    $post = $_POST;
                        ...
                        }elseif(isset($get['id']) && isset($post['orders_ref'])&& isset($post['ems'])) { 
                            $billId = $post['orders_ref'];
                            $ems = $post['ems'];
                            $info = $post['info'];
                            $sql = "UPDATE `orders` SET `ems` = '$ems', `info` = '$info' WHERE `orders`.`orders_ref` = '$billId';";
                            $result = $conn->query($sql);
                            $id = $bill['orders_ref'];
                            if($result) {
                                ...
                                echo "<div class='is-center'><span class='is-green'>บันทึกรหัสจัดส่งของหมายเลข $id แล้ว</span><br /><br /><a class=\"btn btn-default\" href=\"index.php?module=bill&mode=ems\">กลับ</a></div>";
                            }else {
                                echo "<div class='is-center'><span class='is-red'>บันทึกรหัสจัดส่งของหมายเลข $id ไม่สำเร็จ</span><br /><br /><a class=\"btn btn-default\" href=\"index.php?module=bill&mode=ems\">กลับ</a></div>";
                            }
                        }
                    ?>
                    <br>
