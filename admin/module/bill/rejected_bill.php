...
<body ng-controller="content as controller">
    ...
    <div class="col-md-4 content">
		...
		<div class="col-md-8 content">
            <div class="panel panel-default">
                <div class="panel-heading">
                ยกเลิกการชำระเงิน - <?php echo getBillID($conn,$bill['orders_ref']); ?>
                </div>
                <div class="panel-body">
                    <div class="is-center">
                    <?php
                    $get = $_GET;
                        if(isset($get['id'])) {
                            $sql = "UPDATE `payment_confirm` SET `status` = 'REJ' WHERE `payment_confirm`.`id` = $id;";
                            $result = $conn->query($sql);
                            $id = $ordersRef;
                            if($result) {
                                echo "<span class='is-green'>แจ้งยกเลิกการชำระเงินให้กับบิลหมายเลข $id แล้ว</span>";
                            }else {
                                echo "<span class='is-red'>แจ้งยกเลิกการชำระเงินให้กับบิลหมายเลข $id ไม่สำเร็จ</span>";
                            }
