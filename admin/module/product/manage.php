...
<form action="" method="get">
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <?php
                        ...
                        $count = Connect::conn()->count("product",$filter);

                       $row = Connect::conn()->select("product","*",array_merge(["LIMIT" => [$start,$limit]],$filter));
                        ?>
                ...
                <tr>
                  ...
                  <th class="col-xs-3">จำนวนที่เหลือ</th>
                ...
                <?php foreach($row as $key => $value) {
                    ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo "<img class='img-responsive' src='uploads/".$value['src']."' />"; ?>
                                </td>
                                <td>
                                    <?php echo $value['name']; ?>
                                </td>
                                <td>
                                    <?php echo $value['in_stock']; ?>
                                </td>
                                <td>
                                    <a href="index.php?module=product&mode=edit&id=<?php echo $value['id'] ?>" class="btn btn-default">แก้ไข</a>
          ...
          <nav aria-label="Page navigation">
                        <ul class="pagination">
                            <li>
                            <a class="<?php echo 1 == $page ? 'is-hidden':"" ?>" href="index.php?module=product&mode=manage&page=<?php echo isset($_GET['page']) ? $_GET['page']-1:2; ?>" aria-label="Previous">
                            ...
                            for($i=1;$i<=ceil($count / $limit);$i++) {
                                ...
                                echo " <li class='".($page == $i ? 'active':'')."'><a href=\"index.php?module=product&mode=manage&page=$i$textLimit\">$i</a></li>";
                            } ?>
                           
                            <li>
                            <a class="<?php echo ceil($count / $limit) == $page ? 'is-hidden':"" ?>" href="index.php?module=product&mode=manage&page=<?php echo isset($_GET['page']) ? $_GET['page']+1:2; ?>" aria-label="Next">
