...
<div class="box">
            <div class="box-header">
              <h3 class="box-title">จัดการหน้าเสริม</h3>
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <?php
                        ...
                        $count = Connect::conn()->count("page_content",$filter);

                       $row = Connect::conn()->select("page_content","*",array_merge(["LIMIT" => [$start,$limit]],$filter));
                        ?>
